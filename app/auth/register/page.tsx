  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      if (error || data.token === null) {
        setError(error?.message ?? t('common.somethingWentWrong'));
        return;
      }
  ...
  return (
    <div className="min-h-[calc(100vh-3.5rem)] bg-gradient-subtle flex items-center justify-center px-4 py-12">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute bottom-1/3 left-1/4 h-80 w-80 rounded-full bg-accent/20 blur-3xl" />
      </div>
